...
//   const validate = () => {
//     if (form.name.length < 3) return "Enter valid name";
//     if (!/^[6-9]\d{9}$/.test(form.phone)) return "Enter valid phone number";
//     return null;
//   };
...
//         <button
//           disabled={loading}
//           className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-3 rounded-lg font-semibold hover:scale-105 transition duration-300"
//         >
